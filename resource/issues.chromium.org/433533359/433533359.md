...
Comments
All comments
se...@gmail.com<se...@gmail.com> #2Jul 23, 2025 04:24PM
Errata: wasm::FetchDataLoaderForWasmStreaming => wasm::AsyncStreamingDecoder

The bug has a strong b/40088842 vibes :)
...
(Update) Regarding Wasm code cache, likely affects M96~ (ignoring versions affected by b/40057640, see comment#10)
Concerning ReadableStreamBytesConsumer it seems to have been like that forever, at least from M70~ as far as I've checked
Message last modified on Jul 25, 2025 10:13AM
se...@gmail.com<se...@gmail.com> #3Jul 23, 2025 04:35PM
Adding attachments from v8ctf submission b/433662093, RCE to read /flag/flag.

Message last modified on Jul 23, 2025 04:44PM
exploit-ab3b8cf0af3f30d97084b8a727cb40f7a0b81cbadd53195eb840cca943ff810e.tar.gz
20 KB
Download
ts...@google.com<ts...@google.com> #4Jul 23, 2025 11:09PM
...
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #5Jul 23, 2025 11:13PM
...
24...@project.gserviceaccount.com<24...@project.gserviceaccount.com> #6Jul 23, 2025 11:30PM
ClusterFuzz testcase 6345234489212928 appears to be flaky, updating reproducibility hotlist.
24...@project.gserviceaccount.com<24...@project.gserviceaccount.com> #7Jul 23, 2025 11:30PM
...
24...@project.gserviceaccount.com<24...@project.gserviceaccount.com> #8Jul 24, 2025 12:12AM
Detailed Report: https://clusterfuzz.com/testcase?key=6345234489212928
...
A recommended severity was added to this bug. Please change the severity if it is inaccurate.
se...@gmail.com<se...@gmail.com> #9Jul 24, 2025 12:30AM
Re #4: PoC is rather well minimized and commented into a fairly stable repro considering that this exploits a racy bug? If this is about the large inlined script it's just wasm-module-builder.js inlined into the html, I refrain from importing scripts as it's easier to throw a single html for a repro (seems true for CF too) and since script src is observably different in behavior from inlining it. Sorry if this wasn't clear but I've already submitted at least 30 reports in this format and so I assumed that this would be OK. If this is now an issue I can also include it in a separate file and use script src.

se...@gmail.com<se...@gmail.com> #10Jul 24, 2025 05:17AM
The V8 security shepherd + engineers working on Wasm may also be interested in this bug as it also allows V8 Sandbox bypass - but do note that patching only the specific end user wasm::AsyncStreamingDecoder will not work as blink::FetchDataLoaderForWasmStreaming also reads the racy buffer for Wasm code cache digest computation, where a data race between the two likely revives b/40057640.

ml...@google.com<ml...@google.com> #11Jul 24, 2025 05:49PM
Assigned to jk...@chromium.org.
Thank you for the report.

I think therere's multiple issues here:

wasm::AsyncStreamingDecoder and blink::FetchDataLoaderForWasmStreaming
Sandbox bypass
Let's start with the Wasm decoder parts. Jakob, ptal. I think we may also need Blink folks here?

jk...@chromium.org<jk...@chromium.org> #12Jul 24, 2025 07:45PM
...
jk...@chromium.org<jk...@chromium.org> #13Jul 25, 2025 12:13AM
...
Am I missing something? Is there a cheaper way of guarding against this than always making an owned (out-of-sandbox) copy of the bytes, even for non-shared pending_buffer_s?

ml...@chromium.org<ml...@chromium.org> #14Jul 25, 2025 12:33AM
...
ml...@chromium.org<ml...@chromium.org> #15Jul 25, 2025 12:35AM
For the sandbox case (which is arguably a bit different from the general issue), I will have a look.

se...@gmail.com<se...@gmail.com> #16Jul 25, 2025 12:58AM
Re #13:

I explicitly mentioned V8 Sandbox bypass in the report for this specific reason :)

The v8sbx side of this issue is the third case I've mentioned in the summary section (+ comment#10), where with a V8 in-sandbox corruption primitive one can simply modify a normal AB passed through the stream. In fact, ReadableByteStreamController already checks (on the producer side) that the supplied AB is detachable, thus blocking out SABs, then transfers it for a zero-copy transfer to the consumer. With concurrent in-sandbox corruption checks like this still leads to the same data race all over.
...
Message last modified on Jul 25, 2025 10:04AM
th...@chromium.org<th...@chromium.org> #17Jul 25, 2025 05:10AM
...
th...@chromium.org<th...@chromium.org> #18Jul 25, 2025 05:19AM
...
stack-asan-v8-sandbox-testing-linux-release-1490481.txt
9 KB
View
Download
th...@chromium.org<th...@chromium.org> #20Jul 25, 2025 06:40AM
...
Message last modified on Jul 25, 2025 06:40AM
se...@gmail.com<se...@gmail.com> #21Jul 25, 2025 06:43AM
...
ml...@chromium.org<ml...@chromium.org> #22Jul 25, 2025 02:16PM
...
cl...@chromium.org<cl...@chromium.org> #23Jul 25, 2025 06:28PM
...
ch...@google.com<ch...@google.com> #24Jul 25, 2025 07:39PM
Setting milestone because of s0/s1 severity.

cl...@chromium.org<cl...@chromium.org> #25Jul 25, 2025 07:56PM
...
cl...@chromium.org<cl...@chromium.org>Jul 25, 2025 08:57PM
Accepted by cl...@chromium.org.
dx...@google.com<dx...@google.com> #26Jul 25, 2025 11:04PM
Project: v8/v8
Branch:  main
...
Hash: 1eda9300e26ec1aad95f98b6cb8e0d3ca6fb1e92
Date: Fri Jul 25 15:03:18 2025

se...@gmail.com<se...@gmail.com> #27Jul 27, 2025 09:36AM
Re #13, and a small update on #16:

Not sure if there is a way to exploit the code caching part since we need a Response that uses Wasm code cache while also serving a buffer directly from the sandbox. It needs to come from an actual fetch() from http(s) source (src, and v8 blogpost about this) to have the cached_metadata_handler_, and I don't immediately see any cases where such fetch payload is stored inside and served from the sandbox. That being said, it depends on some factors that are not immediately obvious, e.g. some overrides of BytesConsumer::BeginRead() returns in-sandbox buffer while others do not.

cl...@chromium.org<cl...@chromium.org> #28Jul 30, 2025 07:26PM
Marked as fixed.
Since the Wasm path is fixed now (comment #26), I'd like to close this issue as Fixed so we can backmerge the sandbox fix.
...
ch...@google.com<ch...@google.com> #29Jul 30, 2025 07:42PM
...
cl...@chromium.org<cl...@chromium.org> #30Jul 30, 2025 07:46PM
Which CLs should be backmerged? (Please include Gerrit links.)
https://chromium-review.googlesource.com/c/v8/v8/+/6787532
...
(no answer required) Please check the OS custom field to ensure all impacted OSes are checked!
ri...@chromium.org<ri...@chromium.org> #31Jul 31, 2025 07:00AM
...
pg...@google.com<pg...@google.com> #32Aug 1, 2025 03:00AM
merge approved for https://chromium-review.googlesource.com/6787532 nothing concerning in canary/dev as far as I can tell
...
dx...@google.com<dx...@google.com> #33Aug 1, 2025 04:35PM
Project: v8/v8
...
M src/wasm/streaming-decoder.cc
Hash: bfd1d91da0d5b0659f1955a39f1f2c4d8575daa8
Date: Fri Jul 25 15:03:18 2025

pe...@google.com<pe...@google.com> #34Aug 1, 2025 04:44PM
LTS Milestone M138
...
am...@chromium.org<am...@chromium.org> #35Aug 5, 2025 01:03AM
Not considering this fix for backmerge to extended stable

se...@gmail.com<se...@gmail.com> #36Aug 5, 2025 02:17AM
...
I've exploited the v8ctf M138 instance using only this one bug (b/433662093). Not something that I have a say in, but IMHO a backmerge is warranted unless having a known exploitable, unnaturally strong bug in the LTS channel is considered an acceptable risk. Or is a different fix in flight?

am...@chromium.org<am...@chromium.org> #37Aug 5, 2025 02:30AM
Hi, thanks the comment. LTS and Extended Stable are not the same. LTS is a support channel specific to ChromeOS. Extended Stable is an active release channel of Chrome across all platforms, with the exception of Android and iOS.

The comment made in c#35 was related only to Extended Stable, not LTS. This fix cannot be backmerged to Extended Stable at this particular time, given that the backmerge to M139, which is being promoted to Stable channel tomorrow, only occurred on Friday following release RC cut, which was why the review tag was pulled from this issue as it was raising questions from the release team. This change will be re-evaluated for backmerge to M138, which will be promoted to Extended Stable tomorrow, only after the initial release of M139 ships tomorrow and confirmation that there are no issues with that rollout.

se...@gmail.com<se...@gmail.com> #38Aug 5, 2025 02:39AM
...
M src/wasm/streaming-decoder.cc
Hash: c2dd8cf9a9db11c705bbb6b9d0c63ab3f26a8680
Date: Fri Jul 25 15:03:18 2025

sp...@google.com<sp...@google.com> #41Aug 14, 2025 04:55AM
...
am...@chromium.org<am...@chromium.org> #42Aug 14, 2025 04:58AM
...
se...@gmail.com<se...@gmail.com> #43Aug 14, 2025 06:13AM
...
I assume the reward difference between renderer RCE (demoed in comment#3) vs. renderer controlled write is already factored in as part of the combined reward amount?

pe...@google.com<pe...@google.com> #44Sep 29, 2025 11:42PM
...
rz...@google.com<rz...@google.com> #45Sep 29, 2025 11:58PM
https://chromium-review.googlesource.com/c/v8/v8/+/6861456
Low, no conflicts
138, 139, 140
Yes
ch...@google.com<ch...@google.com> #46Nov 6, 2025 07:39PM
