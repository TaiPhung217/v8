Title: V8 Sandbox Bypass: AAR/W via WASM signature confusion in Wasm-to-JS wrapper through PodArrayOfWasmValueType overwrite
# Headers
Reporter
...
Comments
All comments
se...@gmail.com<se...@gmail.com> #2Jul 21, 2024 01:46PM
...
an...@chromium.org<an...@chromium.org> #3Jul 22, 2024 10:05PM
...
se...@gmail.com<se...@gmail.com> #4Jul 22, 2024 10:27PM
Note that in a "big picture" this is similar to b/350292240 as both of them start from some kind of trusted data and follow handles back to in-sandbox data.

sr...@google.com<sr...@google.com>Jul 23, 2024 04:05PM
Reassigned to jk...@google.com.
pe...@google.com<pe...@google.com>Jul 23, 2024 04:13PM
Reassigned to jk...@chromium.org.
cl...@chromium.org<cl...@chromium.org> #5Jul 24, 2024 05:21PM
...
sr...@google.com<sr...@google.com> #6Jul 24, 2024 05:50PM
...
sa...@chromium.org<sa...@chromium.org> #7Jul 24, 2024 06:00PM
We could also consider some follow-up work to make this code pattern harder to introduce or easier to spot. For example, we have a way of enforcing that a given unit of code does not read data from inside the sandbox with our HardwareSandboxSupport::MaybeBlockAccess scopes. This way, we can guarantee that no untrusted data is read during certain operations. We could also probably build something into our object visitors (I guess?) that warns about trusted -> untrusted references. Although we definitely have a bunch of such references that are legitimate, so we'd need a way of marking those as such.

se...@gmail.com<se...@gmail.com> #8Jul 24, 2024 06:10PM
Re #5:
...
cl...@chromium.org<cl...@chromium.org> #9Jul 24, 2024 06:16PM
...
cl...@chromium.org<cl...@chromium.org> #10Jul 24, 2024 06:53PM
...
View
Download
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #11Jul 24, 2024 06:55PM
...
cl...@chromium.org<cl...@chromium.org> #12Jul 24, 2024 07:56PM
I am investigating two potential solutions:

Canonicalize the signature and store a raw pointer into the type canonicalizer's storage (like we do for WasmExportedFunctionData).
Switch to TrustedPodArray.
...
cl...@chromium.org<cl...@chromium.org> #13Jul 24, 2024 08:14PM
Some bot really insists that this in untriaged. I'll just ignore that for now.

ap...@google.com<ap...@google.com> #14Jul 25, 2024 06:48PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #15Jul 25, 2024 09:00PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #16Jul 26, 2024 12:28AM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #17Jul 26, 2024 10:37PM
Project: v8/v8
Branch: main
...
cl...@chromium.org<cl...@chromium.org> #18Jul 30, 2024 12:02AM
...
cl...@chromium.org<cl...@chromium.org> #19Jul 30, 2024 12:17AM
FYI, this is the prototype: https://crrev.com/c/5746215

Still fails 44 tests locally.

ap...@google.com<ap...@google.com> #20Jul 30, 2024 12:26AM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #21Aug 22, 2024 05:35PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #22Aug 22, 2024 09:13PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #23Aug 22, 2024 09:58PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #24Aug 22, 2024 10:49PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #25Aug 26, 2024 04:08PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #26Aug 29, 2024 10:35PM
Project: v8/v8
Branch: main
...
ap...@google.com<ap...@google.com> #27Oct 4, 2024 07:39PM
Project: v8/v8
Branch: main
Author: Clemens Backes <clemensb@chromium.org>
...
ap...@google.com<ap...@google.com> #28Oct 4, 2024 08:21PM
Project: v8/v8
Branch: main
Author: Clemens Backes <clemensb@chromium.org>
...
24...@project.gserviceaccount.com<24...@project.gserviceaccount.com> #29Oct 5, 2024 02:34PM
...
se...@gmail.com<se...@gmail.com> #30Oct 7, 2024 04:15AM
FYI, you might want to check out b/371565065 which is closely related to this issue - not a v8sbx bypass, but a memory corruption vulnerability.

sp...@google.com<sp...@google.com> #31Oct 10, 2024 04:55AM
...
am...@chromium.org<am...@chromium.org> #32Oct 10, 2024 05:09AM
Congratulations Seunghyun! Thank you for another excellent sandbox bypass report.

pe...@google.com<pe...@google.com> #33Jan 12, 2025 10:40PM
