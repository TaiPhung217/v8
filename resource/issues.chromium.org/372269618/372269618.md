Title: Type confusion due to DefaultReferenceValue() `undefined` default value for kNoExtern
...
Summary
Note: Bug split out from b/372285204 as this is technically a different bug.
...
Bisect
Bug introduced by commit 2e357c4 in M112 that introduced wasm null.
...
Comments
All comments
ph...@chromium.org<ph...@chromium.org> #2Oct 9, 2024 08:24PM
...
se...@gmail.com<se...@gmail.com> #3Oct 9, 2024 08:30PM
WasmNull itself is introduced in M112, but the attached PoC uses imported strings proposal shipped in M130: https://crrev.com/c/5837501
...
pe...@google.com<pe...@google.com> #4Oct 9, 2024 10:36PM
Setting milestone because of s0/s1 severity.

pe...@google.com<pe...@google.com> #5Oct 9, 2024 10:36PM
Setting Priority to P1 to match Severity s1. If this is incorrect, please reset the priority. The automation bot account won't make this change again.

se...@gmail.com<se...@gmail.com> #6Oct 10, 2024 02:18AM
Hi, I've found a way to exploit these patterns of type confusion. Will upload a PoC shortly, but note that every one of these types of patterns will be exploitable - this means that all cases where a non-null value resides in a nullable bottom (none, noextern, noexn) type are exploitable. This has quite a bit of an implication as AFAICT there were many such cases, e.g. b/372285204, https://crrev.com/c/5854179, etc.

Message last modified on Oct 10, 2024 04:03AM
se...@gmail.com<se...@gmail.com> #7Oct 10, 2024 03:28AM
...
Key idea is as described in #1: Optimizing compilers (in this case, Turboshaft) may falsely optimize out code as unreachable, resulting in various typer problems. I have not checked whether or not Turbofan is exploitable as it is scheduled to be replaced with Turboshaft soon (b/362191724).

An overview of how type confusion is achieved is as the following pseudocode (FYI the PoC code is also well-commented):

Set $global : ref null noextern = undefined using this bug
Set $local2 : ref any = dummy where dummy : ref $s2 of any WASM struct type
Run ref.as_non_null (global.get $global)
WasmGCTypeAnalyzer::ProcessAssertNotNull() -> WasmGCTypeAnalyzer::RefineTypeKnowledge() computes wasm::Intersection() of ref null noextern and ref noextern, which invalid and thus returns kWasmBottom
...
Outer loop:
Inner loop:
ref.cast $s2 (local.get $local2)
Typer currently tracks $local2 type as ref $s2, thus the cast statically succeeds
Return the casted value (on second run)
Dummy branch back to inner loop (not taken in runtime)
This effectively creates a loop phi
Set $local2 = attacker-controlled $s1
Now typer knows that $local2 : wasm::Union(ref $s1, ref $s2)
This should trigger loop reprocessing (https://crrev.com/c/4958777). However, as both the loops are considered unreachable this is not triggered.
...
Message last modified on Oct 11, 2024 05:38AM
poc.js
77 KB
View
Download
se...@gmail.com<se...@gmail.com> #8Oct 10, 2024 03:42AM
...
View
Download
se...@gmail.com<se...@gmail.com> #9Oct 10, 2024 03:55AM
...
turboshaft-typer-logging-patch.diff
13 KB
View
Download
log_unreachable.txt
...
View
Download
se...@gmail.com<se...@gmail.com> #10Oct 10, 2024 09:58AM
Exploit that pops calc on a --enable-features=WebAssemblyTurboshaft --no-sandbox renderer in Windows x64, tested on 129.0.6668.90. Also attached is the same exploit that uses https://crrev.com/c/5854179 (b/364917763) to demonstrate the effectiveness of this technique, tested on the same version.

Other similar bugs like https://crrev.com/c/5867409 may also work in the same way.

exp_372269618_turboshaft_noextern.html
90 KB
View
Download
exp_364917763_turboshaft_wrapper.html
90 KB
View
Download
cf...@google.com<cf...@google.com> #11Oct 10, 2024 04:26PM
Reassigned to ml...@chromium.org.
Great work!

mliedtke@, could you PTAL?

ml...@chromium.org<ml...@chromium.org>Oct 10, 2024 07:56PM
Accepted by ml...@chromium.org.
ap...@google.com<ap...@google.com> #12Oct 11, 2024 03:35PM
Marked as fixed.
Project: v8/v8
Branch: main
...
ml...@chromium.org<ml...@chromium.org> #13Oct 11, 2024 03:51PM
...
Missing tracing for the WasmGCTypeAnalyzer.
Reducing the risk of allowing logic bugs (like the undefined in a nullexternref to become a type confusion thanks to type optimizations.
See comment #7:
...
ap...@google.com<ap...@google.com> #14Oct 11, 2024 10:33PM
Project: v8/v8
Branch: main
...
pe...@google.com<pe...@google.com> #15Oct 11, 2024 10:57PM
...
am...@chromium.org<am...@chromium.org> #16Oct 12, 2024 01:22AM
...
se...@gmail.com<se...@gmail.com> #17Oct 12, 2024 02:36AM
Re #10: As expected, b/366635354 also works with something like below:
...
Wasm-opaque type (noextern, noexn): Exploitable as shown in comment#7 - ref.as_non_null
b/372269618, b/372285204, b/364917763
...
b/366635354
Other typer bugs
br_on_cast* typing issues in b/352720899?
Packed integer issues in b/342602616, although top type patch in wasm::Union may block this
Implicit kExternString conversion issues in b/324747822, where this report proves that wasm (or more specifically, Turboshaft compiler) can in fact pivot type inconsistencies in opaque type hierarchies (externref, and even exnref) further into exploitable confusions in wasm type hierarchy
...
Message last modified on Oct 13, 2024 01:18PM
pe...@google.com<pe...@google.com> #18Oct 12, 2024 10:43PM
...
ml...@chromium.org<ml...@chromium.org> #19Oct 14, 2024 03:14PM
It's a security vulnerability.
https://chromium-review.googlesource.com/c/v8/v8/+/5922878
Yes, https://chromiumdash.appspot.com/commit/e7ccf0af1bdddd20dc58e1790a94739dba0209a3
No.
-
No.
ap...@google.com<ap...@google.com> #20Oct 14, 2024 06:08PM
Project: v8/v8
Branch: main
Author: Matthias Liedtke <mliedtke@chromium.org>
...
am...@chromium.org<am...@chromium.org> #21Oct 16, 2024 08:22PM
...
ap...@google.com<ap...@google.com> #22Oct 16, 2024 08:44PM
Project: v8/v8
Branch: main
Author: Matthias Liedtke <mliedtke@chromium.org>
...
ap...@google.com<ap...@google.com> #23Oct 16, 2024 10:12PM
Project: v8/v8
...
pe...@google.com<pe...@google.com> #24Oct 16, 2024 10:19PM
LTS Milestone M126
...
pe...@google.com<pe...@google.com> #25Oct 21, 2024 12:45PM
...
ml...@chromium.org<ml...@chromium.org> #26Oct 21, 2024 03:22PM
1, https://chromium-review.googlesource.com/c/v8/v8/+/5922878
...
Yes, merged to 130.
Yes, this fixes a security vulnerability.
qk...@google.com<qk...@google.com> #27Oct 21, 2024 03:27PM
...
sp...@google.com<sp...@google.com> #28Oct 23, 2024 03:55AM
...
am...@chromium.org<am...@chromium.org> #29Oct 23, 2024 04:08AM
...
Message last modified on Oct 23, 2024 04:09AM
se...@gmail.com<se...@gmail.com> #30Oct 23, 2024 04:58AM
Thanks for going through all the reports :D

I still do think that b/372285204 is technically a different bug as there are two independent problems, just fixed in a single CL:

Missing case for exn type hierarchy leading to wasm_null leakage - adding exn to the conditional would still have caused the latter problem
Misuse of undefined value for host type hierarchies - changing it to null would still have caused the former problem
I don't have strong opinions on this decision - especically since the fix is indeed local in terms of code - but I do think neither bug implies the other, especially from b/372285204 to this bug. But yeah, I thought this would score a "novelty bonus" for the first demonstrated & RCA'd Turboshaft typer exploit technique but instead landed a dup which is a bit discouraging ;_;

se...@gmail.com<se...@gmail.com> #31Oct 30, 2024 10:50PM
...
am...@chromium.org<am...@chromium.org> #32Nov 5, 2024 01:28AM
...
ap...@google.com<ap...@google.com> #33Nov 7, 2024 07:42PM
Project: v8/v8
...
pe...@google.com<pe...@google.com> #34Jan 18, 2025 10:43PM
This bug has been closed for more than 14 weeks. Removing issue access restrictions.

dx...@google.com<dx...@google.com> #35May 29, 2026 08:41PM
Project: v8/v8
Branch:  main
