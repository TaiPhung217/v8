Title: Incorrect node replacement optimization during Maglev graph construction leads to RCE
...
https://chromium-review.googlesource.com/c/v8/v8/+/6127161
HW
--
Introduced In
--
...
Try to convert value into an int32 constant node.
Try to get the int32 type alias node of value.
If no existing node can be found, insert a type check node based on the current type of value. If the type check is not satisfied, then deoptimize.
...
Insert n10: CheckedNumberToInt32(n7) node. This node will check whether the HeapNumber object can be safely converted to SMI.
Set the kInt32 type alias of the n7 node to the n10 node.
...
Without checking whether JSArray::length is a valid SMI, allocate memory for JSArray::elements in the v8 heap.
Without checking whether JSArray::length is a valid SMI, take the pointer as the length to achieve out-of-bounds read and write.
...
But I'm still not satisfied because if an invalid object is read during the out-of-bounds read, it may crash. Therefore, we can directly write a floating-point number object into arr[0]. In this way, while reallocating Elements, it also sets arr's elements_kind to PACKED_DOUBLE_ELEMENTS. This way, we can control every bit through floating-point numbers and don't have to worry about crashes.
...
Comments
All comments
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #2Dec 31, 2024 01:11AM
...
am...@chromium.org<am...@chromium.org> #3Dec 31, 2024 01:13AM
...
am...@chromium.org<am...@chromium.org>Dec 31, 2024 01:13AM
Assigned to vi...@chromium.org.
am...@chromium.org<am...@chromium.org>Dec 31, 2024 01:16AM
Reassigned to le...@chromium.org.
am...@chromium.org<am...@chromium.org>Dec 31, 2024 01:17AM
Reassigned to vi...@chromium.org.
24...@project.gserviceaccount.com<24...@project.gserviceaccount.com> #4Dec 31, 2024 01:26AM
Automatically applying components based on crash stacktrace and information from OWNERS files.

If this is incorrect, please apply the hotlistid:4801165.
am...@chromium.org<am...@chromium.org> #5Dec 31, 2024 01:29AM
poking around the code, assigning this to victorgomes@ given their recent work in int32 in this code space, but please feel free to assign to someone else if there is a better owner here; Setting foundin- as Extended Stable out of caution (and since I can't trust the CF repro), but looking at the code, it looks possible this could have been introduced more recently. Please update the Found-In to correct milestone if needed.

pe...@google.com<pe...@google.com> #6Dec 31, 2024 10:42PM
Setting milestone because of s0/s1 severity.

vi...@chromium.org<vi...@chromium.org>Jan 2, 2025 07:42PM
Accepted by vi...@chromium.org.
vi...@chromium.org<vi...@chromium.org> #7Jan 2, 2025 11:17PM
...
24...@project.gserviceaccount.com<24...@project.gserviceaccount.com> #10Jan 3, 2025 02:31PM
...
sp...@google.com<sp...@google.com> #11Jan 17, 2025 10:56PM
...
am...@chromium.org<am...@chromium.org> #12Jan 17, 2025 11:16PM
...
ch...@google.com<ch...@google.com> #13Apr 11, 2025 07:50PM
