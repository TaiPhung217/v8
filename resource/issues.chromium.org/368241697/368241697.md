...
Bisect
Module size check bug introduced by commit 549692c in M63 that introduced WASM streaming compilation.
30-bit offset optimization introduced by commit e557383 in M99 that optimizes constant expression decoding.
VERSION
See bisect commit release info in Chromium Dash for more info: 549692c, e557383
...
Comments
All comments
se...@gmail.com<se...@gmail.com> #2Sep 20, 2024 02:19PM
Attached full exploit exp.html that pops calc from a --no-sandbox renderer. Tested on Windows x86-64, Chrome build 131.0.6727.0 (Official Build) (latest canary). The latter parts regarding v8sbx escape and RCE are copied without any modification from b/360533914, b/365802567.
...
Message last modified on Sep 24, 2024 09:11AM
exp.html
90 KB
View
Download
se...@gmail.com<se...@gmail.com> #3Sep 21, 2024 12:12AM
...
Note Blink's WasmStreamingCallback and the testing mode WasmStreamingCallback. The former actually streaming decodes the body from a Response/Promise<Response>, while the latter simply receives an ArrayBuffer and then runs GetFirstArgumentAsBytes() which triggers the check against max_module_size() which is absent in the former.
--module to enable top-level awaits
Message last modified on Sep 22, 2024 12:17AM
poc.js
77 KB
View
Download
se...@gmail.com<se...@gmail.com> #4Sep 23, 2024 04:46AM
Verified that the bug exists from at least M99.

Attached a PoC that crashes while attempting to SetFunctionTableEntry() on an undefined entry. This results in type confusion from undefined to WasmInternalFunction, ultimately resulting in a crash while deserializing fake WasmCapiFunction's serialized_signature (based on types from M99). Tested on branch base position 961656, matching 99.0.4844.0. Note that even on that version the bug is still likely to be exploitable due to how external points to tagged address that may be fully controlled by the attacker (as shown by the arrays spray in the PoC).

poc_m99_961656.html
81 KB
View
Download
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #5Sep 23, 2024 08:30PM
...
se...@gmail.com<se...@gmail.com> #6Sep 23, 2024 09:25PM
...
se...@gmail.com<se...@gmail.com> #7Sep 23, 2024 10:03PM
ASAN log from a local run of the first PoC (comment#1) with the same build as that of https://clusterfuzz.com/testcase?key=6041534784798720.
...
==8504==ABORTING
sk...@google.com<sk...@google.com> #8Sep 24, 2024 02:12AM
Assigned to cl...@google.com.
Assigning to the latest code editor!
pe...@google.com<pe...@google.com>Sep 24, 2024 02:13AM
Reassigned to cl...@chromium.org.
cl...@chromium.org<cl...@chromium.org> #9Sep 24, 2024 04:26PM
...
Message last modified on Sep 24, 2024 10:02PM
jk...@chromium.org<jk...@chromium.org> #12Sep 24, 2024 10:36PM
#11: Good point, thanks! That's what I get for addressing reviewer feedback without testing again :-)

Fixed in patch set 3.

pe...@google.com<pe...@google.com> #13Sep 24, 2024 10:43PM
Setting milestone because of s0/s1 severity.

pe...@google.com<pe...@google.com> #14Sep 24, 2024 10:43PM
This is a serious security regression. If you are not able to fix this quickly, please revert the change that introduced it.

If this doesn't affect a release branch, or has not been properly classified for severity, please update the Security Impact hotlist or the Severity field, and remove the ReleaseBlock hotlist.

se...@gmail.com<se...@gmail.com> #15Sep 24, 2024 10:45PM
Re #12: Aside from the crashiness, according to this comment it is illegal to call Finish() after Fail(), which is misleading considering how the whole function extensively uses ok() to check failure state?

ap...@google.com<ap...@google.com> #16Sep 25, 2024 04:23PM
Marked as fixed.
Project: v8/v8
Branch: main
...
jk...@chromium.org<jk...@chromium.org> #17Sep 25, 2024 04:44PM
#15: That just seems to be an inaccurate comment. Fix: https://chromium-review.googlesource.com/c/v8/v8/+/5890745

am...@chromium.org<am...@chromium.org> #18Oct 1, 2024 12:00AM
...
am...@chromium.org<am...@chromium.org> #19Oct 1, 2024 12:59AM
...
am...@chromium.org<am...@chromium.org> #20Oct 2, 2024 05:18AM
...
ap...@google.com<ap...@google.com> #21Oct 2, 2024 08:43PM
Project: v8/v8
...
pe...@google.com<pe...@google.com> #22Oct 2, 2024 08:44PM
LTS Milestone M126
...
ap...@google.com<ap...@google.com> #23Oct 2, 2024 08:45PM
Project: v8/v8
...
ap...@google.com<ap...@google.com> #24Oct 2, 2024 08:47PM
Project: v8/v8
...
sp...@google.com<sp...@google.com> #25Oct 3, 2024 07:56AM
...
am...@chromium.org<am...@chromium.org> #26Oct 3, 2024 08:02AM
...
se...@gmail.com<se...@gmail.com> #27Oct 3, 2024 08:34AM
Thanks! I'd like to donate this bounty through Benevity too.

On another note, I'm planning to disclose details of many WASM-related vulnerabilities (including V8 Sandbox bypasses) that I've reported at POC2024 (Nov. 7-8) and CODE BLUE 2024 (Nov. 14-15), possibly including unfixed V8 Sandbox bypasses (but excluding b/362780326). Would this be OK?

se...@gmail.com<se...@gmail.com> #28Oct 3, 2024 08:39AM
...
Going through all of your WASM reports -- which there are five by my count (please correct me if I'm wrong) -- with only 1 being within what we would consider an acceptable disclosure period for severity high issues impacting Stable channel: crbug.com/351327767 -- resolved 11 July

The remaining four are not what we'd consider in an acceptable window for disclosure.

This one, which was only just resolved 25 September
crbug.com/362780326 -- still open / not yet resolved
crbug.com/365802567 -- resolved 17 September
crbug.com/360533914 -- resolved 20 August
...
se...@gmail.com<se...@gmail.com> #31Oct 4, 2024 01:13AM
...
b/344608204 - TyphoonPWN 2024 submission, already public
b/346197738 - variant of the above, already public
b/351327767 - fixed Jul 11
I can be flexible with V8 Sandbox bypasses, especially those that are unresolved, as there are no concrete expectations to meet for the talk. But do note that exploit for b/351327767 involves the use of b/350292240 which still isn't fixed, but which is soon reaching the 14 week deadline.

I understand that the disclosure & fix dates of b/360533914, b/365802567, b/368241697 (and b/362780326, which is rather a non-issue really) are too recent and that these would preferrably be not included in the talk. The original comment may have been miscommunicated - it was not a unidirectional announcement but more of a question of whether the disclosure of these bugs could be coordinated so that these could be included in the talk, but agreeably this seems to be not the case.
...
am...@chromium.org<am...@chromium.org> #32Oct 4, 2024 03:25AM
...
pe...@google.com<pe...@google.com> #33Oct 4, 2024 07:43PM
...
qk...@google.com<qk...@google.com> #34Oct 4, 2024 07:48PM
...
jk...@chromium.org<jk...@chromium.org> #35Oct 4, 2024 09:24PM
...
jk...@chromium.org<jk...@chromium.org> #36Oct 4, 2024 09:27PM
#31/#32: Just a quick note regarding issue 350292240: yes, that one's still on the to-do list. It's an example of the overall "we know the sandbox isn't complete yet" situation. We'll get to it as soon as time permits (currently working on other cases where the sandbox is known not to be complete yet).

qk...@google.com<qk...@google.com> #37Oct 7, 2024 12:18PM
> I do recommend backmerging https://chromium-review.googlesource.com/c/v8/v8/+/5905241 to any milestones you still care about.

Thank you for pointing it out. I abandon https://crrev.com/c/5906825.
gm...@google.com<gm...@google.com> #38Oct 8, 2024 09:49PM
Merge approved for https://chromium-review.googlesource.com/c/v8/v8/+/5905241
ap...@google.com<ap...@google.com> #39Oct 10, 2024 02:09PM
Project: v8/v8
...
Expand for full commit details
pe...@google.com<pe...@google.com> #40Jan 2, 2025 10:41PM
This bug has been closed for more than 14 weeks. Removing issue access restrictions.

by...@gmail.com<by...@gmail.com> #41Jan 8, 2025 06:16AM
Comment has been deleted.
Message last modified on Jan 8, 2025 06:19AM