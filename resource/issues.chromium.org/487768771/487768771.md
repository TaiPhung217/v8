Title: Debug check failed: IsInBounds(index).
...
https://chromium-review.googlesource.com/c/v8/v8/+/7623620
HW
--
Introduced In
92
...
Object.values(ta) / Object.entries(ta) enters the fast path.
FastGetOwnValuesOrEntries allocates the result array using one length snapshot:
src/objects/js-objects.cc:2240
src/objects/js-objects.cc:2249
Then it enters TypedArray element collection:
src/objects/js-objects.cc:2254
src/objects/elements.cc:3719
TypedElementsAccessor::CollectValuesOrEntriesImpl reads the current length again and writes in a loop:
...
Comments
All comments
aj...@google.com<aj...@google.com> #2Feb 27, 2026 01:51AM
Assigned to md...@google.com.
Hits a d8 dcheck
...
ch...@google.com<ch...@google.com> #3Feb 27, 2026 07:38PM
Setting milestone because of s0/s1 severity.

ch...@google.com<ch...@google.com> #4Feb 27, 2026 07:38PM
Setting Priority to P1 to match Severity s1. To ensure SLOs are tracked correctly, priority must exceed severity.

md...@google.com<md...@google.com>Feb 27, 2026 09:43PM
Reassigned to ma...@chromium.org.
ma...@chromium.org<ma...@chromium.org> #5Mar 2, 2026 05:49PM
...
ma...@chromium.org<ma...@chromium.org> #6Mar 2, 2026 07:33PM
The fix is underway.
...
qy...@gmail.com<qy...@gmail.com> #7Mar 2, 2026 07:55PM
...
ma...@chromium.org<ma...@chromium.org> #8Mar 2, 2026 08:06PM
...
qy...@gmail.com<qy...@gmail.com> #9Mar 2, 2026 08:13PM
...
ma...@chromium.org<ma...@chromium.org> #10Mar 2, 2026 08:15PM
...
qy...@gmail.com<qy...@gmail.com> #11Mar 2, 2026 08:20PM
...
qy...@gmail.com<qy...@gmail.com> #12Mar 2, 2026 08:23PM
Especially when you're reproducing the issue at https://issues.chromium.org/issues/487746373, you might hit various checks, such as "Check failed: isolate_ == isolate" and "Check failed: new_capacity <= old_capacity." You might also hit various signal 11 SEGV errors.

ma...@chromium.org<ma...@chromium.org> #13Mar 2, 2026 08:41PM
...
qy...@gmail.com<qy...@gmail.com> #14Mar 2, 2026 09:55PM
Sorry, I just saw your reply and apologize for keeping you waiting. I've been debugging locally, trying to find the problem. However, I can still reproduce the issue correctly with asan version (it rarely triggers the check). Do you think this could be due to the d8 version or system environment (since it's a race condition, I think this is possible)?
...
qy...@gmail.com<qy...@gmail.com> #15Mar 2, 2026 10:00PM
...
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #16Mar 3, 2026 12:08AM
...
dx...@google.com<dx...@google.com> #17Mar 3, 2026 04:49PM
Marked as fixed.
Project: v8/v8
Branch:  main
...
Hash: 02cd73dfc58dbe73054382c85f9f126af9ce597e
Date: Mon Mar 2 19:05:25 2026

ml...@google.com<ml...@google.com> #18Mar 3, 2026 05:51PM
...
qy...@gmail.com<qy...@gmail.com> #19Mar 3, 2026 06:38PM
Hello, could you please review the CF results in comment #16? It shows that no check were triggered. The reason we discussed the check issue earlier was that the initial js had too many iterations.

The poc.js in comment #15 does not trigger check, and it is detected by dcheck

I would like to request that the severity be changed to S1.

Thank you for taking the time to review this.

ml...@chromium.org<ml...@chromium.org> #20Mar 3, 2026 06:45PM
Comment #16 (CF) doesn't show any crasher (CHECK) or segfault. It's not a valid reproduction.

I can try with Comment #15 again.
...
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #21Mar 3, 2026 06:48PM
...
qy...@gmail.com<qy...@gmail.com> #22Mar 3, 2026 08:17PM
...
ml...@google.com<ml...@google.com> #23Mar 3, 2026 08:23PM
I believe the CF results already demonstrate that this poc.js does not trigger any check on an ASan build without dcheck enabled. This is exactly what I have been trying to prove all along: this poc.js does not hit any check.

The CF repro doesn't show anything. We have no way of telling apart CF from doing a regular access versus an illegal access if there's no crash. We need to reproduce a segfault on a release build, since the general observation through code review was that this is covered in a CHECK() (comment #6).
...
qy...@gmail.com<qy...@gmail.com> #24Mar 4, 2026 01:14PM
...
OOB write at index 65530 crosses into the next 256KB block (PROT_NONE) → SIGSEGV
...
ml...@google.com<ml...@google.com> #25Mar 4, 2026 03:55PM
...
The assumption was that there's mitigating factors with always crashing in a CHECK right after the OOB write. (comment #6)
...
qy...@gmail.com<qy...@gmail.com> #26Mar 4, 2026 04:49PM
...
ch...@google.com<ch...@google.com> #27Mar 4, 2026 07:44PM
...
ma...@chromium.org<ma...@chromium.org> #28Mar 5, 2026 03:08PM
Re: whether the CHECK always triggers shortly after the OOB write.

We're here: https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.cc;l=2259?q=FastGetOwnValuesOrEntries&ss=chromium
...
The OOB write happens inside the CollectValueOrEntries func. The MAYBE_RETURN only returns if the thing is empty, which it isn't here.

Then we write some more (now potentially OOB) into values_and_entries. In the repro, there aren't any own descriptors, but in a variant repro, there could be:
...
Message last modified on Mar 5, 2026 03:09PM
ma...@chromium.org<ma...@chromium.org> #29Mar 5, 2026 03:13PM
Which CLs should be backmerged? (Please include Gerrit links.)
...
qy...@gmail.com<qy...@gmail.com> #30Mar 5, 2026 04:10PM
Thanks for your reply, ma. I carefully reviewed the code snippet you pointed out, and you are right.

The poc.js I provided in comment #24 actually writes into the PROT_NONE guard page before reaching the return. That naturally causes an early crash, but it does not demonstrate that the issue can be exploited in a way that avoids being caught by check.
...
ma...@chromium.org<ma...@chromium.org> #31Mar 5, 2026 04:33PM
...
dr...@chromium.org<dr...@chromium.org> #32Mar 7, 2026 11:23PM
Given the severity, I don't think we need to merge this. Removing merge labels.

ch...@google.com<ch...@google.com> #33Jun 10, 2026 02:53PM
This bug has been closed for more than 14 weeks. Removing issue access restrictions.

sp...@google.com<sp...@google.com> #34Jun 16, 2026 04:54AM
