Title: WASM type confusion due to imported tag signature subtyping
...
Details
The following code in InstanceBuilder::ProcessImports() processes WASM imports, including tags:
...
Exploitation with WASM type confusion primitives is trivial and has been presented multiple times. (Pwn2Own Vancouver 2024, TyphoonPWN 2024, v8CTF submission 8d4d57cb2258, b/360533914, ...)

Bisect
Bug introduced by commit 1ef0a09 in M111 that introduced isorecursive canonicalization to tag signatures.
...
Comments
All comments
se...@gmail.com<se...@gmail.com> #2Sep 11, 2024 06:49AM
...
Message last modified on Sep 11, 2024 10:52AM
se...@gmail.com<se...@gmail.com> #3Sep 11, 2024 08:51AM
...
View
Download
cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #4Sep 11, 2024 09:58PM
...
se...@gmail.com<se...@gmail.com> #5Sep 11, 2024 10:13PM
Re #4, anunoy@: Don't we need linux_asan_chrome_mp or windows_asan_chrome for html repros?

an...@chromium.org<an...@chromium.org> #6Sep 12, 2024 01:02AM
Yes, you are right! I think I must have seen your original poc.js file and selected linux_asan_d8. Thanks for catching that! Let me restart another job.

cl...@appspot.gserviceaccount.com<cl...@appspot.gserviceaccount.com> #7Sep 12, 2024 01:04AM
...
se...@gmail.com<se...@gmail.com> #8Sep 12, 2024 05:18AM
...
==527971==ABORTING
an...@chromium.org<an...@chromium.org> #9Sep 12, 2024 05:43AM
...
pe...@google.com<pe...@google.com>Sep 12, 2024 06:04AM
Reassigned to is...@chromium.org.
is...@chromium.org<is...@chromium.org> #10Sep 12, 2024 03:12PM
Reassigned to ma...@chromium.org.
Assigning to Wasm folks for further investigation.

th...@chromium.org<th...@chromium.org> #11Sep 12, 2024 06:49PM
...
se...@gmail.com<se...@gmail.com> #12Sep 12, 2024 08:46PM
...
Message last modified on Sep 12, 2024 09:17PM
th...@chromium.org<th...@chromium.org> #13Sep 12, 2024 09:22PM
Hm, the spec does say "are the same" in the condition (side-note: I would expect it to say "tag tagtype_1 and tag tagtype_2 are the same" otherwise this seems ill-defined).
...
se...@gmail.com<se...@gmail.com> #14Sep 12, 2024 09:59PM
Ah, so in the GC spec types like func and global changed to being "matched" ("a notion of subtyping", as in the GC spec terminology), but the tag type still remains as tagtypes being "the same". The confusion seems to be from the EH spec using the same "match" terminology which is redefined in the GC spec. I agree that the tag case should better be explicitly called out to avoid confusion.

pe...@google.com<pe...@google.com> #15Sep 13, 2024 10:38PM
Setting milestone because of s0/s1 severity.

pe...@google.com<pe...@google.com> #16Sep 13, 2024 10:38PM
Setting Priority to P1 to match Severity s1. If this is incorrect, please reset the priority. The automation bot account won't make this change again.

ap...@google.com<ap...@google.com> #17Sep 17, 2024 11:09PM
Marked as fixed.
Project: v8/v8
Branch: main
...
pe...@google.com<pe...@google.com> #18Sep 18, 2024 01:37AM
Security Merge Request Consideration: This is sufficiently serious that it should be merged to extended stable. But I can't see a Chromium repo commit here,so you will need to investigate what - if anything - needs to be merged to M128. Is there a fix in some other repo which should be merged? Or, perhaps this ticket is a duplicate of some other ticket which has the real fix: please track that down and ensure it is merged appropriately. Security Merge Request Consideration: This is sufficiently serious that it should be merged to stable. But I can't see a Chromium repo commit here,so you will need to investigate what - if anything - needs to be merged to M129. Is there a fix in some other repo which should be merged? Or, perhaps this ticket is a duplicate of some other ticket which has the real fix: please track that down and ensure it is merged appropriately. Security Merge Request Consideration: This is sufficiently serious that it should be merged to dev. But I can't see a Chromium repo commit here,so you will need to investigate what - if anything - needs to be merged to M130. Is there a fix in some other repo which should be merged? Or, perhaps this ticket is a duplicate of some other ticket which has the real fix: please track that down and ensure it is merged appropriately. Security Merge Request: Thank you for fixing this security bug! We aim to ship security fixes as quickly as possible, to limit their opportunity for exploitation as an "n-day" (that is, a bug where git fixes are developed into attacks before those fixes reach users).
...
th...@chromium.org<th...@chromium.org> #19Sep 18, 2024 03:13PM
...
4. No
5. No
pe...@google.com<pe...@google.com> #20Sep 18, 2024 11:13PM
Merge approved: your change passed merge requirements and is auto-approved for M130. Please go ahead and merge the CL to branch 6723 (refs/branch-heads/6723) manually. Please contact milestone owner if you have questions. Merge instructions: https://chromium.googlesource.com/chromium/src.git/+/refs/heads/main/docs/process/merge_request.md Owners: eakpobaro (Android), eakpobaro (iOS), gmpritchard (ChromeOS), danielyip (Desktop)

pe...@google.com<pe...@google.com> #21Sep 18, 2024 11:13PM
...
pe...@google.com<pe...@google.com> #22Sep 18, 2024 11:13PM
...
th...@chromium.org<th...@chromium.org> #23Sep 18, 2024 11:15PM
...
5. NA
6. NA
am...@chromium.org<am...@chromium.org> #24Sep 19, 2024 11:20PM
Merge to M130 was already approved Not seeing any issues related to this fix on Canary; merges approved for M129 Stable (12.9) and M128 Extended Stable (12.8), please go ahead and merge this change by 10am Pacific Time on Friday, 20 September so this change can be included in the next security updates -- thanks

ap...@google.com<ap...@google.com> #25Sep 20, 2024 10:06PM
Project: v8/v8
...
ap...@google.com<ap...@google.com> #26Sep 20, 2024 10:08PM
Project: v8/v8
...
ap...@google.com<ap...@google.com> #27Sep 20, 2024 10:10PM
Project: v8/v8
...
pe...@google.com<pe...@google.com> #28Sep 20, 2024 10:12PM
LTS Milestone M126
...
pe...@google.com<pe...@google.com> #29Sep 24, 2024 12:43PM
...
qk...@google.com<qk...@google.com> #30Sep 24, 2024 12:48PM
1. https://chromium-review.googlesource.com/c/v8/v8/+/5872320
2. Low, no conflicts
3. 128, 129, and 130
4. Yes
sp...@google.com<sp...@google.com> #31Sep 30, 2024 10:57PM
...
am...@chromium.org<am...@chromium.org> #32Sep 30, 2024 11:03PM
Congratulations Seunghyun! Thank you for your excellent efforts with this report and exploit -- great work!

se...@gmail.com<se...@gmail.com> #33Sep 30, 2024 11:59PM
Hi, I'd like to donate the bounty to a charity on Benevity (also see b/368503788), does Chrome VRP also support donations through Benevity vouchers?

am...@chromium.org<am...@chromium.org> #34Oct 1, 2024 12:21AM
...
ap...@google.com<ap...@google.com> #35Oct 1, 2024 08:36AM
Project: v8/v8
...
pe...@google.com<pe...@google.com> #36Dec 25, 2024 10:42PM
This bug has been closed for more than 14 weeks. Removing issue access restrictions.

ap...@google.com<ap...@google.com> #37Feb 6, 2025 09:58PM
Project: v8/v8
Branch: main
